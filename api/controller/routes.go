...
func (s *Server) initializeRoutes(){
	...
	s.Router.HandleFunc("/api/games/", middleware.SetMiddlewareJSON(s.Home)).Methods("GET")
	s.Router.HandleFunc("/api/games/create", middleware.SetMiddlewareJSON(s.CreateGame)).Methods("GET")
